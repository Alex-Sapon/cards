                            ...
                            <div className={styles.profileItems}>
                                <Stack direction="row" spacing={2}>
                                    <Badge
                                        ...
                                        <Avatar alt="Travis Howard" src={avatar || userPhoto}
                            ...
                            <div className={styles.name}>
                                {isEditMode
                                    ...
                                    : <>Nickname:
                                        ...
                                        {!!activateViewMode &&
                                            <ModeEditIcon onClick={activateEditMode} fontSize={'small'}/>}
                                    </>}
                            </div>
                            <div>
                                <div className={styles.profileTitle}>Email: {email}</div>
                                <div className={styles.profileTitle}>Количество создоваемых
                                    колод: {publicCardPacksCount}</div>
                            </div>
